...
* In Polypane:
  ...
  This is the default mode in Polypane. Unique to Polypane is that it allows you to see [multiple different sizes side-by-side](./simulate-multiple-devices.md).
